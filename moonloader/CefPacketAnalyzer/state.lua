...
M.state = {
    ...
    backgroundUpload = false, -- прямой режим: агрегат отправляется на вебхук сразу из игры (каждый клиент шлёт сводку сам). true = фоновый: файл в pending/, отправку делает ПК-сборщик.
