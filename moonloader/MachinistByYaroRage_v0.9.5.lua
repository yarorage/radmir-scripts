...
-- v0.9.5 — БЕЗНАТИВНЫЙ ГЕЙТ ПОЕЗДА (фикс фризов в обычных машинах):
...
-- давали постоянные фризы). Гейт автопилота — безнативный CEF-детект inCabNow() по
-- свежим RX-пакетам интерфейса 'Machinist'; в обычной машине пакетов нет — нативных
