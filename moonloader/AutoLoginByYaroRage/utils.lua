...
-- Отправка CEF-пакета id=215 с командой OnPlayerClientSideKey (эмуляция клавиши)
-- Формат (41 байт): D7 | 02 00 00 00 | 00 00 | len=21 | "OnPlayerClientSideKey" | 02 00 00 00 | 0x64 | VK-код int32
-- Клавиши кодируются Windows VK-кодами (W=0x57, A=0x41, S=0x53, D=0x44, C=0x43, ...)
