...
function main()
	...
	sampRegisterChatCommand('mhelp', function()
		sampShowDialog(9999, "{FFFFFF}������� ������-���� by YaroRage.", '/mcheat - ������� ���� �����-����\n/mhelp - ������� ��� ����\n/fake - ���� ����� ��� �������� �������\n/rec - ���������, ��������� � ����\n/ctime - ����� �� ������ � �������������\n/skin - ����������(������)\n/slp - �������� ������ ����\n/sc - �������� �� �������\n/autorem - ��������/��������� �������������� ������\n/wolic - ���� ��� ����\n/pcol - ���� �� ��������\n/st /sw - ����� ������� � ������\n/fakepl - �������� ���, ����� ������ (id, ���, id ������ � �������� ����� ����� ����, id �����)\n/clan - ���������\n/fix - �������� ����\n/breakecar - ������� ���� ��� ���������� ���\nAlt + 1 - ������� ������ ����\nAlt + 2 - ������� ����� ����', "� ���", "", 0)
	end)
	...
	if mcheat.v then
		...
		imgui.BeginChild("##MainGroup", imgui.ImVec2(winW, winH), true, imgui.WindowFlags.NoScrollbar)
			imgui.BeginGroup()
				...
				if imgui.RadioButton(u8'��������� Trigger', triggermode, 3) then
					triggermode.v = 3
					save()
				end
				imgui.NewLine()
				...
				if imgui.RadioButton(u8'��������� Silent Aim', silentmode, 3) then
					silentmode.v = 3
					save()
				end
				imgui.NewLine()
				...
				imgui.TextQuestion(u8'���� �� ����� ���������.')
				sbox(u8'������ �� �� �����/payday', capturebiz)
				imgui.TextQuestion(u8'��� ��������� � ���� ������� � ���������� ����� - ������ /capture_biz.')
